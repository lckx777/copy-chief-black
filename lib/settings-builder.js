...
function buildMcpJson(opts = {}) {
  ...
  const vars = {
    ...
    FIRECRAWL_API_KEY: opts.firecrawlApiKey || process.env.FIRECRAWL_API_KEY || '',
    SCRAPECREATORS_API_KEY: opts.scrapecreatorsApiKey || process.env.SCRAPECREATORS_API_KEY || '',
    GEMINI_API_KEY: opts.geminiApiKey || process.env.GEMINI_API_KEY || '',
